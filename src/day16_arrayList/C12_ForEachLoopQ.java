...
// sonra da tek olan sayilari for each loop kullanarak farkli listeye ekleyip
        // yazdiran bir method hazirlayin
    ...
    public static void tekCiftListesi (int[] arr){
        ...
        List<Integer> ciflerListesi = new ArrayList<>();
        ...
        for (int each: arr
            ...
            if (each % 2 == 0){
                ciflerListesi.add(each);
            }else {
                teklerListesi.add(each);
            }

        }
        System.out.println("array icindeki ciftler listesi : "+ciflerListesi);
