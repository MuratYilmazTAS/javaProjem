...
public class C04_MethodOverloading {
    ...
    adim adim ilerler.
    1-eger argumentler ile parametreler tamamen uyumluysa onu calistirir
    2-eger argument ve parametreler %100 uyumlu degilse, casting yapabilir miyim diye bakar
    3-casting ile calistiracagi birden fazla method bulursa, en az casting ile calistiracagini tercih eder
     */
