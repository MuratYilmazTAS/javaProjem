...
public class C06_get {
    public static void main(String[] args) {
        ...
        // bir array olusturup loop ile tum elementleri olusturdugumuz list'e ekleyebiliriz
        ...
        System.out.println(harfList.get(harfList.size()-1)); // e son harf icin  .size kullanilir.
        System.out.println(sayiList.get(0)); // 3
        System.out.println(sayiList.get(sayiList.size()-1)); // 6 son harf icin yine  .size kullandim
    }
}
